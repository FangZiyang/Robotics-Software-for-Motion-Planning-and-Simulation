...
The interview component follows a McMaster Research Ethics Board (MREB) protocol. Ethics approval is still under review at the time of writing; the protocol number and clearance date will be inserted once approval is granted.
% TODO: the MREB application is under review; insert the protocol number and clearance date once approval is granted.
...
% TODO: interviews are pending MREB approval at the time of writing; once approval is granted and interviews are conducted, report the developer findings in Chapter~\ref{ch:developer-interviews} (do not fabricate findings).
