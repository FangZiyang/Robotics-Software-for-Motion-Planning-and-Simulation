...
The primary activity indicator used in this report is the Domain~X 18-month repository-activity flag: a package receives the value \emph{alive} if its measured repository has received any commit or version release within the 18 months preceding the measurement date, and \emph{dead} otherwise. The flag records repository events; it does not by itself establish that substantive software development or project stewardship is continuing. AirSim illustrates this distinction. Its measured repository, \texttt{microsoft/AirSim}, has a last commit date of 2026-03-15 and therefore receives an alive value under the 18-month rule. However, the project's README has stated since 2022 that development has ended (``no further updates will be made, effective immediately'') and directs users to Project AirSim; the later commits are README-level changes. AirSim is therefore treated as officially discontinued despite its alive repository-activity flag.

The flag was used as a weighted signal rather than as an automatic cutoff: a package was set aside on activity grounds only when prolonged inactivity coincided with the tool no longer being prominent or having been superseded by an actively maintained alternative. On that basis, the following packages were excluded:
