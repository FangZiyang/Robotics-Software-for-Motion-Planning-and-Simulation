...
All 28 packages provide installation instructions, and all provide some form of installation automation (makefiles, scripts, package managers, or container definitions). For comparison, the Medical Imaging study~\cite{Dong2021} reported that only about half of MI packages installed successfully, so the MPS coverage on this dimension is markedly better.
