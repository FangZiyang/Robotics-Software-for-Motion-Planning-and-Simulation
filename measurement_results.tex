...
Readers can browse the complete measurement dataset interactively on the \href{https://domainx.cas.mcmaster.ca}{DomainX project page}, under the \emph{Robotics Software for Motion Planning and Simulation} entry, which presents every package's raw scores together with the generated figures. The same package-by-question table is also archived with the thesis materials in the \href{https://github.com/FangZiyang/Robotics-Software-for-Motion-Planning-and-Simulation/blob/main/AI-Agent/summary_measured.csv}{project repository}. The tables in this chapter summarize that record; Table~\ref{tab:overall-impressions} later reports every package's nine impression scores.
