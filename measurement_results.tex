...
These observations are descriptive and are based on the specific measurement procedure, time frame, and interpretation rules described in Chapter~\ref{ch:methodology}. They are not claims that any single package is universally superior. Chapter~\ref{ch:comparison-research-software} interprets these results against prior State-of-the-Practice studies, and Chapter~\ref{ch:conclusions} answers the research questions in light of the evidence.
