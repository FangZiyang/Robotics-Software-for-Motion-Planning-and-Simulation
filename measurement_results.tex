...
\textbf{The relationship between community popularity and measurement scores is not linear.} AirSim leads in GitHub stars by a wide margin (18,159) but scores in the middle tier (7--8) across most quality categories. This is consistent with the finding in the MI study~\cite{Dong2021} that GitHub popularity and measurement-based rankings do not always align. Popularity metrics are cumulative and backward-looking, while measurement scores reflect current documentation and process quality.
