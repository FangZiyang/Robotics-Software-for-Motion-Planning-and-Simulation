...
The measurements use public artifacts as evidence for software qualities, a practical proxy that does not capture every aspect of the underlying constructs: visible testing evidence does not prove that a package is correct, and visible issue-tracking activity does not fully describe maintainability. Mention counts likewise measure how often a package appears across candidate sources, not how good the software is (Section~\ref{sec:mention-count-ranking}). Repository stars measure attention to one hosted repository, not adoption or community opinion. Older repositories have had longer to accumulate stars; migrations divide the history; and Bitbucket watchers are not directly comparable with GitHub stars. These problems limit the AHP-versus-stars comparison in Section~\ref{sec:quality-vs-community}, as also noted in the LBM assessment~\citep{Smith2024LBM}. The choice of quality categories is itself a construct threat: the nine categories applied here (Section~\ref{subsec:measurement-template}) are one reasonable decomposition of ``software quality'' rather than the only one, and because the impression scores involve assessor judgement (Section~\ref{sec:threat-reliability}), a reader who defines or weights quality differently could reach different conclusions.
