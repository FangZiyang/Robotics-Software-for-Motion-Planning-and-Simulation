...
\begin{description}[font=\rmfamily\bfseries, leftmargin=3cm, style=nextline]
	\item[$CR$] Consistency ratio (Analytic Hierarchy Process)
	\item[$CI$] Consistency index (Analytic Hierarchy Process; not to be confused with CI\,=\,Continuous Integration in the Abbreviations list)
...
\begin{description}[font=\rmfamily\bfseries, leftmargin=3cm, style=nextline]
	...
	\item[Software family] A set of programs whose common properties are extensive enough that studying them collectively is advantageous before analysing individual members~\cite{Parnas1976}.
