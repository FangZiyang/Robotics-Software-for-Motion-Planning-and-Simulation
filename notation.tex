...
\begin{description}[font=\rmfamily\bfseries, leftmargin=3cm, style=nextline]
	...
	\item[$\mathit{RI}$] Random index for a pairwise-comparison matrix of a given size (Analytic Hierarchy Process)
	\item[$n$] Dimension of a pairwise-comparison matrix (Analytic Hierarchy Process)
