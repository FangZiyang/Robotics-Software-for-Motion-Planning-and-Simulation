...
\begin{enumerate}
    ...
    \item Prepare the developer-interview component needed to supplement the artifact-based results with evidence about developer pain points and best practices.
\end{enumerate}
...
\begin{itemize}
    ...
    \item \textbf{Chapter~\ref{ch:developer-interviews}} describes the planned developer-interview component for MPS software and identifies the interview evidence still needed to answer RQ6--RQ9: the evidence base, recurring pain points, practices used to address them, quality-related findings, and cross-domain comparison.
