...
These consequences make software quality a central concern for motion planning and simulation software. A simulator that produces incorrect trajectories, or a planner that crashes under realistic inputs, can compromise experimental results in ways that are not immediately obvious. Qualities such as correctness, reliability, and long-term sustainability are important for MPS software.
...
This report adapts the State-of-the-Practice methodology~\citep{Smith2021}. The scope and exclusions were reviewed with a domain expert to reduce the risk of misrepresenting the domain. At a high level, the methodology consists of the following steps:
...
\begin{itemize}
    ...
    \item \textbf{Chapter~\ref{ch:developer-interviews}} reports the developer pain points for MPS software: a summary of the pain points, what developers do about them, and recommended practices.
