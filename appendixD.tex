...
The full filtered candidate list, including packages excluded at each step, is preserved in the project materials (\texttt{examples/software-list-counting-result.xlsx}).
