...
\usepackage{pdflscape} % Landscape pages for wide package-level variability tables
...
]{hyperref} % Visible links to labels, citations, and external URLs
...
\afterpreface
  ...
  \include{selected_software_commonality}
        \setcounter{figure}{0}
        \setcounter{equation}{0}
        \setcounter{table}{0}

  \include{measurement_results}
        \setcounter{figure}{0}
        \setcounter{equation}{0}
        \setcounter{table}{0}

  \include{comparison_research_software}
        \setcounter{figure}{0}
        \setcounter{equation}{0}
        \setcounter{table}{0}
