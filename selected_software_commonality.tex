...
The commonality analysis follows the approach described by Weiss~\cite{Weiss1997} and is based on evidence from project documentation, repositories, publications, and other reliable sources. Capabilities described as likely but not yet verified against project materials are explicitly noted.
...
\textbf{C4: Open-Source Repository Hosting.} All 28 packages use public version control hosting (GitHub for 27 of 28 packages) with visible commit history, issue tracking, and pull request management. This shared infrastructure is both a selection criterion and a commonality of the study set.
