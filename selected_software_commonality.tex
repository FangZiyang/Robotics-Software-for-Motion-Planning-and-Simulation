...
\textbf{V5: Platform Support.} Nearly all packages support Linux (27 of 28 in the measured records; the PhysX platform field recorded only Windows, a known under-report discussed in Chapter~\ref{ch:measurement-results}), and support for other platforms varies. Some packages provide first-class support for Windows and macOS (Webots, CoppeliaSim, Bullet), while others are primarily developed for Linux with limited cross-platform support.
...
\hline
V5: Platform support & Windows-only (as recorded), Linux-only, Linux + Windows, Linux + Windows + macOS & Specification / build time \\
\hline
