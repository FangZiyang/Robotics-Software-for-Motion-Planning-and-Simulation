...
The interview protocol, recruitment logic, ethics status, and analysis procedure are described in Section~\ref{sec:interview-component} of Chapter~\ref{ch:methodology}. Once MacREM approval, recruitment, consent, and analysis are complete, this chapter will report only evidence that is supported by approved interview records or consented summaries.
